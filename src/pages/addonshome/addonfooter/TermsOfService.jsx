    ...
    <div className="relative w-full bg-gradient-to-b from-amber-200 via-amber-100 to-yellow-200">
      ...
      <div className="max-w-7xl mx-auto py-20 px-6 sm:px-12 lg:px-24 flex flex-col items-center space-y-14">
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5"> Products and Services</h2>
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Order Process</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Pricing and Payments</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Shipping and Delivery</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5"> Returns and Exchanges</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5"> Contact Information</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Address</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Limitation of Liability</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Privacy and Data Protection</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5"> Customer Obligations</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
        ...
        <section className="w-full mx-auto text-left">
          <h2 className="text-3xl sm:text-4xl font-bold text-amber-800 mb-5">Modifications to Terms of Service</h2>
          <p className="text-lg sm:text-xl text-amber-700 leading-relaxed">
